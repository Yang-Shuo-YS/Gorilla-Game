...
if __name__ == '__main__':
    ...
    while winner == 0:
        ...
        vel = display_msg.vel
        angle = display_msg.angle
        turn = display_msg.turn

        if turn == 1 :
            bgd.drawText('vel : {}'.format(vel), skylineSurf, 2, 16, bgd.WHITE_COLOR, bgd.SKY_COLOR)
            bgd.drawText('angle : {}'.format(angle), skylineSurf, 2, 30, bgd.WHITE_COLOR, bgd.SKY_COLOR)
        else:
            bgd.drawText('vel : {}'.format(vel), skylineSurf, 538, 16, bgd.WHITE_COLOR, bgd.SKY_COLOR)
            bgd.drawText('angle : {}'.format(angle), skylineSurf, 538, 30, bgd.WHITE_COLOR, bgd.SKY_COLOR)
